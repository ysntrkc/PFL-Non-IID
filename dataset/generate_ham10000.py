...
def generate_dataset(dir_path, num_clients, num_classes, niid, balance, partition):
    ...
    trainset = HAM10000(root=dir_path + "rawdata/train/", transform=transform)
    testset = HAM10000(root=dir_path + "rawdata/validation/", transform=transform)
