...
def average_data(algorithm="", dataset="", goal="", times=10, args=None):
    test_acc = get_all_results_for_one_algo(algorithm, dataset, goal, times, args)
...
def get_all_results_for_one_algo(
    algorithm="", dataset="", goal="", times=10, args=None
):
    test_acc = []
